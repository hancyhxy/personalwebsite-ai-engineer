...
const imgs=names.map(n=>{const i=new Image();i.src=`assets/hero-portrait/${n}.webp`;return i});
...
const identityLine=document.querySelector('.resume-identity-line'),identityWord=$('resume-identity-word'),identityWords=['product','experiential','content','visual'];let identityIndex=0,identityTimer=0,identityDwell=0,identityVisible=false;
